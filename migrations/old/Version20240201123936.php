 ...
 */
final class Version20240201123936 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE eleve (id INT AUTO_INCREMENT NOT NULL, maison_id INT NOT NULL, promotion_id INT DEFAULT NULL, INDEX IDX_ECA105F7139DF194 (promotion_id), INDEX IDX_ECA105F79D67D8AF (maison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
